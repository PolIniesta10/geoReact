    ...
    <>
        <div class="body-404">	
            <div class="background-404">
                <div class="ground-404"></div>
            </div>
            <div class="container-404">
                <div class="left-section-404">
                    <div class="inner-content-404">
                        <h1 class="heading-404">404</h1>
                        <p class="subheading-404">Looks like the page you were looking for is no longer here.</p>
                    </div>
                </div>
                <div class="right-section-404">
