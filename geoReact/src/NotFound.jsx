    ...
    <>
        <div className="body-404">	
            <div className="background-404">
                <div className="ground-404"></div>
            </div>
            <div className="container-404">
                <div className="left-section-404">
                    <div className="inner-content-404">
                        <h1 className="heading-404">404</h1>
                        <p className="subheading-404">Looks like the page you were looking for is no longer here.</p>
                    </div>
                </div>
                <div className="right-section-404">
